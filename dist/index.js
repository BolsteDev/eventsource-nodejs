...
/***/ function(module, exports, __webpack_require__) {
	...
	var eventSource = new EventSource('./activity?lastEventId=100');
...
/***/ function(module, exports) {
	...
	(function (global) {
	  ...
	  var getDuration = function getDuration(value, def) {
	    var n = value;
	    if (n !== n) {
	      n = def;
	    }
	  ...
	  var isEventSourceSupported = function isEventSourceSupported() {
